...
| :--- | :--- | :--- |
| **Windows Installer** | **[Setup.exe](https://github.com/xanzinfl/Projects/releases/download/Stoner-Toolsv1.0.0/Stoner.Tools.Setup-v1.0.0.exe)** | Recommended. Installs the application and adds it to your start menu. |
| **Portable Version** | **[Portable.exe](https://github.com/xanzinfl/Projects/releases/download/Stoner-Toolsv1.0.0/Stoner.Tools.Portable-v1.0.0.exe)** | A single executable. No installation needed, just download and run. |
